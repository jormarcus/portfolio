...
const About = () => {
  ...
  return (
    ...
    >
      ...
      <p className="mb-3">
        I then worked as a developer at <span className="font-medium">ADP</span>{' '}
        for nearly four years working on multiple projects. These included a
        redesign and transformation of <span className="font-medium">ADP</span>
